...
- **Locale-Specific Prompts**: English and Russian prompts are now independently tailored
- **Anthropic API Compliance**: Fixed tool format and message structure for proper API communication
- **Improved Error Handling**: Added exception handling for unexpected API errors
